...
export type UserProfileFormFieldsProps = {
    ...
    isFieldVisible?: (attribute: Attribute) => boolean;
...
export function UserProfileFormFields(props: UserProfileFormFieldsProps) {
    const { onIsFormSubmittableValueChange, isFieldVisible, BeforeField, AfterField } = props;
    ...
    return (
        <>
            {formFieldStates.map(({ attribute, displayableErrors, valueOrValues }) => {
                const doDisplayField =
                    attribute.annotations.inputType !== "hidden" &&
                    (isFieldVisible === undefined || isFieldVisible(attribute));
                ...
                return (
                    <Fragment key={attribute.name}>
                        ...
                        <div
                            ...
                            style={{
                                display: doDisplayField ? undefined : "none"
                            }}
                        >
